...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_modernizr__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pure_functions_js__ = __webpack_require__(7);
/**
...
const {universalRequired, universalTypes, checkingPasswords, checkYoonger, getBirthdayTimestamp, sendForm, transferReceivedData} = __WEBPACK_IMPORTED_MODULE_1__pure_functions_js__;


(function(){
    var form = document.forms[0];
    var elements = form.elements;
    var birth = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(document.forms[0].elements.birthdays);
//    var valid = {};  //create an object for checking the accurance of the form information, if some inaccurance - false, else - true
    ...
    reset.onclick = function(){
        var spans = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()("span.message");
        for (var i=0; i<7; i++){
            __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(spans[i]).text("");
        }
    }
...
//    }
    ...
    returnInfoButton.onclick = function(event){
        event.preventDefault();
        __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default.a.getJSON("/user").done(function(data){
    ...
    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.password).on("focus",function(){
        __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(this).removeClass("cross","check-mark");
    });
    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.confpassword).on("focus",function(){
        __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(this).removeClass("cross","check-mark");
    });

    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.password).on("blur",function(){
        var valid = {};
        checkingPasswords(valid,elements, mistakesMessage);
    });

    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.confpassword).on("blur",function(){
        var valid = {};
        checkingPasswords(valid,elements, mistakesMessage);
    })
    ...
    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(birth).on("change",function(){
        var valid = {};
        checkYoonger(getBirthdayTimestamp(birth), valid, elements, mistakesMessage,birth); // transfer milliseconds from birth date
    });


    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.smallers).on("change", function(){
    ...
    __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.shortstory).on("input keypress",function(event){
        var max = 140;
        var valueLength = event.target.value.length;
        var leftSymbols = max-valueLength;
        __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(".symbols-left").text(leftSymbols);
        var localSpanMessage = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(event.target).siblings('.message');
        if (leftSymbols<1){
            ...
            __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(".symbols-left").addClass("red");
        } else {
            localSpanMessage.text("");
            __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(".symbols-left").removeClass("red");
        }
    })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["universalRequired"] = universalRequired;
/* harmony export (immutable) */ __webpack_exports__["universalTypes"] = universalTypes;
/* harmony export (immutable) */ __webpack_exports__["checkingPasswords"] = checkingPasswords;
/* harmony export (immutable) */ __webpack_exports__["checkYoonger"] = checkYoonger;
/* harmony export (immutable) */ __webpack_exports__["getBirthdayTimestamp"] = getBirthdayTimestamp;
/* harmony export (immutable) */ __webpack_exports__["sendForm"] = sendForm;
/* harmony export (immutable) */ __webpack_exports__["transferReceivedData"] = transferReceivedData;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js__);
/**
...
function universalRequired(valid,elements, mistakesMessage){
    for (var i = 0; i<elements.length; i++){
        if (elements[i].hasAttribute("required")){  // elements[i].required - also possible
            var input = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements[i]);
...
function universalTypes(valid,elements, typesCheck) {
    try {
        for (var i = 0; i<elements.length; i++){
            ...
            var el = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements[i]);
...
function checkingPasswords(valid,elements,mistakesMessage){
    var password = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.password);
    var span1 = password.next();
    var confpassword = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(elements.confpassword);
    ...
    try {
        ...
        if (dateToCompareMil >= newOneMil){
            ...
            if (elements.smallers.checked === true){
                ...
                __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(".show-when-small").show(); //??
                __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()("#smallers").attr("required",true);
                valid[elements.smallers.name] = false;
                message.text(mistakesMessage[4]);
            }
        } else {
            __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(".show-when-small").hide();
            __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()("#smallers").removeAttr("required");
            valid[elements.smallers.name] = true;
            message.text("");
        }
    } catch(error){
...
//            }
        ...
        var content = __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default()(form).serialize();
        console.log(content);
        __WEBPACK_IMPORTED_MODULE_0__vendor_jquery_min_js___default.a.post("/user",content).done(function(){
            console.log("done");
        }).fail(function(){
            console.log("fail");
        }).always(function(){
