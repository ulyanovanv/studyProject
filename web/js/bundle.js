...
!function (a, b) {
  ...
  var c = [],
    ...
    function b() {
      if (i) {
        ...
        i = d.createElement("div");i.style && (i.style.backgroundClip = "first-page-content-box", i.cloneNode(!0).style.backgroundClip = "", o.clearCloneStyle = "first-page-content-box" === i.style.backgroundClip, h.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", h.appendChild(i), r.extend(o, { pixelPosition: function pixelPosition() {
        return b(), c;
  ...
  }, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, "function" == "function" && __webpack_require__(20) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return r;
...
exports.OneIngredient = undefined;
...
var OneIngredient = exports.OneIngredient = function (_React$Component) {
    _inherits(OneIngredient, _React$Component);

    function OneIngredient() {
        _classCallCheck(this, OneIngredient);

        return _possibleConstructorReturn(this, (OneIngredient.__proto__ || Object.getPrototypeOf(OneIngredient)).apply(this, arguments));
    }

    _createClass(OneIngredient, [{
        key: "render",
        value: function render() {

            var color = this.props.isSelected ? colors.red : colors.white;
            return _react2.default.createElement(
                "div",
                { className: "img-cell", style: { 'boxShadow': '0px 0px 12px 5px ' + color }, onClick: this.props.onClick },
...
var _pureFunctions = __webpack_require__(25);
 ...
 */
var universalRequired = functions.universalRequired,
    universalTypes = functions.universalTypes,
    checkingPasswords = functions.checkingPasswords,
    checkYoonger = functions.checkYoonger,
    getBirthdayTimestamp = functions.getBirthdayTimestamp,
    sendForm = functions.sendForm,
    transferReceivedData = functions.transferReceivedData;


(function () {
    var form = document.forms[0];
    var elements = form.elements;
    var birth = (0, _jqueryMin2.default)(document.forms[0].elements.birthdays);
    ...
    reset.onclick = function () {
        var spans = (0, _jqueryMin2.default)("span.message");
        for (var i = 0; i < 7; i++) {
            (0, _jqueryMin2.default)(spans[i]).text("");
        }
    };
    ...
    returnInfoButton.onclick = function (event) {
        event.preventDefault();
        _jqueryMin2.default.getJSON("/user").done(function (data) {
    ...
    (0, _jqueryMin2.default)(elements.password).on("focus", function () {
        (0, _jqueryMin2.default)(this).removeClass("cross", "check-mark");
    });
    (0, _jqueryMin2.default)(elements.confpassword).on("focus", function () {
        (0, _jqueryMin2.default)(this).removeClass("cross", "check-mark");
    });

    (0, _jqueryMin2.default)(elements.password).on("blur", function () {
        var valid = {};
        checkingPasswords(valid, elements, mistakesMessage);
    });

    (0, _jqueryMin2.default)(elements.confpassword).on("blur", function () {
        var valid = {};
        checkingPasswords(valid, elements, mistakesMessage);
    });
    ...
    (0, _jqueryMin2.default)(elements.shortstory).on("input keypress", function (event) {
        var max = 140;
        var valueLength = event.target.value.length;
        var leftSymbols = max - valueLength;
        (0, _jqueryMin2.default)(".symbols-left").text(leftSymbols);
        var localSpanMessage = (0, _jqueryMin2.default)(event.target).siblings('.message');
        if (leftSymbols < 1) {
            ...
            setTimeout(function () {
                elements.shortstory.disabled = false;
            }, 1000);
        } else if (leftSymbols < 11) {
            localSpanMessage.text("left few symbols");
            (0, _jqueryMin2.default)(".symbols-left").addClass("red");
        } else {
            localSpanMessage.text("");
            (0, _jqueryMin2.default)(".symbols-left").removeClass("red");
        }
    });
})();
...
exports.universalRequired = universalRequired;
exports.universalTypes = universalTypes;
exports.checkingPasswords = checkingPasswords;
exports.checkYoonger = checkYoonger;
exports.getBirthdayTimestamp = getBirthdayTimestamp;
...
function universalRequired(valid, elements, mistakesMessage) {
    for (var i = 0; i < elements.length; i++) {
        if (elements[i].hasAttribute("required")) {
            // elements[i].required - also possible
            var input = (0, _jqueryMin2.default)(elements[i]);
            var par = input.parent();
            var span = par.children('.message');
            if (input.val()) {
                //it means there is any text at least
                span.text("");
...
function universalTypes(valid, elements, typesCheck) {
    try {
        for (var i = 0; i < elements.length; i++) {
            ...
            var el = (0, _jqueryMin2.default)(elements[i]);
...
function checkingPasswords(valid, elements, mistakesMessage) {
    var password = (0, _jqueryMin2.default)(elements.password);
    var span1 = password.next();
    var confpassword = (0, _jqueryMin2.default)(elements.confpassword);
    var span2 = confpassword.next();
    var passwordValue = password.val();
    var confpasswordValue = confpassword.val();
    if (valid[elements.password.name] === false || valid[elements.confpassword.name] === false) {
        // if already dring first 2 universal check was false, than no sense to check on
        return valid;
    }
...
function checkYoonger(dateToCompareMil, valid, elements, mistakesMessage, birth) {
    try {
        if (valid[elements.birthdays.name] === false) {
            // if already false after universal checks, no sense to check
            return valid;
        }
        var current = new Date(); //создается сегодняшняя дата
        var curYear = current.getFullYear();
        ...
        if (dateToCompareMil >= newOneMil) {
            if (dateToCompareMil > maxMil) {
                // if it is already future -> return
            ...
            if (elements.smallers.checked === true) {
                ...
                (0, _jqueryMin2.default)(".show-when-small").show(); //??
                (0, _jqueryMin2.default)("#smallers").attr("required", true);
                valid[elements.smallers.name] = false;
                message.text(mistakesMessage[4]);
            }
        } else {
            (0, _jqueryMin2.default)(".show-when-small").hide();
            (0, _jqueryMin2.default)("#smallers").removeAttr("required");
            valid[elements.smallers.name] = true;
            message.text("");
        }
    } catch (error) {
...
function sendForm(event, valid, elements, form) {
    try {
        ...
        var content = (0, _jqueryMin2.default)(form).serialize();
        console.log(content);
        _jqueryMin2.default.post("/user", content).done(function () {
            console.log("done");
        }).fail(function () {
            console.log("fail");
        }).always(function () {
...
(function () {
    var greyDisplay = (0, _jqueryMin2.default)(".hidden-menu__grey-display");
    var firstPage = (0, _jqueryMin2.default)(".first-page");
    var secondPage = (0, _jqueryMin2.default)(".second-page");
    var hiddenMenu = (0, _jqueryMin2.default)(".hidden-menu");

    var missions = (0, _jqueryMin2.default)("#mission");
    var mainPage = (0, _jqueryMin2.default)("#main-page");
    var rates = (0, _jqueryMin2.default)("#rates");
    var samples = (0, _jqueryMin2.default)("#samples");
    ...
    function GreyDisplayAppering() {
        greyDisplay.animate({ opacity: 0 }, 1000, null, function () {
            (0, _jqueryMin2.default)(this).css({
                "display": "none"
            });
        });
    ...
    function TurnToSecondPage() {
        firstPage.animate({ opacity: 0 }, 1000, null, function () {
            (0, _jqueryMin2.default)(this).css({ display: "none" });
...
var _rezept = __webpack_require__(40);
...
var MainContainer = function (_React$Component) {
    ...
    function MainContainer(props) {
        ...
        _this.setEmpty = _this.setEmpty.bind(_this);
        return _this;
    }

    _createClass(MainContainer, [{
        key: 'changeLayout',
        value: function changeLayout(ingredients) {
            if (ingredients) {
        ...
        value: function render() {
            if (this.state.threeChosenElements.length > 0) {
                return _react2.default.createElement(_rezept.Rezept, { chosenInredientsImages: this.state.threeChosenElements, turnToFirstPage: this.setEmpty });
            }
            return _react2.default.createElement(_ingredients.ImagesContainer, { pushIngridients: this.changeLayout });
        }
    }]);
...
exports.ImagesContainer = undefined;
...
var _eachOne = __webpack_require__(17);
...
var images = ["/images/reactIngredients/mushrooms.jpg", "/images/reactIngredients/beans.jpg", "/images/reactIngredients/corn.jpg", "/images/reactIngredients/lentils.jpg", "/images/reactIngredients/peanuts.jpg", "/images/reactIngredients/potatoes.jpg", "/images/reactIngredients/sunflower.jpg", "/images/reactIngredients/walnuts.jpg", "/images/reactIngredients/white-beans.jpg"];

var ImagesContainer = exports.ImagesContainer = function (_React$Component) {
    _inherits(ImagesContainer, _React$Component);

    function ImagesContainer(props) {
        _classCallCheck(this, ImagesContainer);

        var _this = _possibleConstructorReturn(this, (ImagesContainer.__proto__ || Object.getPrototypeOf(ImagesContainer)).call(this, props));
    ...
    _createClass(ImagesContainer, [{
        key: 'clickAction',
        value: function clickAction(picture) {
            var isSelected = this.state.selectedImages.indexOf(picture) !== -1;
            var currentImages = this.state.selectedImages;
            if (isSelected) {
                console.log(isSelected);
                var index = currentImages.indexOf(picture);
                if (index > -1) {
        ...
        value: function renderList() {
            ...
            return images.map(function (picture) {
                var isSelected = _this2.state.selectedImages.indexOf(picture) !== -1;
                return _react2.default.createElement(_eachOne.OneIngredient, { key: picture,
                    src: picture,
                    isSelected: isSelected,
                    onClick: function onClick() {
                        return _this2.clickAction(picture);
                    }
                });
            });
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'func-center' },
                _react2.default.createElement(
                    'p',
                    { className: 'span-decor' },
                    'Please, select 3 ingredients for Receipe'
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'img-flex-container' },
                    this.renderList()
                )
            );
        }
...
var textDescription = ["Sukower welsfilet mit Ofenkartoffeln", "Exotishes Haenchen-Kokos-Curry", "Saftiges schweinfilet mit Sengkruste", "Herhafter Gemuese-Flammkuchen", "Haenchenbrust in Cranberrrysosse", "Vietnamesisches Rindfleisch", "Gelbes Thai-Curry", "Putenbrust mit Schrfem Brokkolini", "Schweinelachsstreifen auf Basmatireis"];

var Rezept = exports.Rezept = function (_React$Component) {
    _inherits(Rezept, _React$Component);

    function Rezept(props) {
        _classCallCheck(this, Rezept);

        return _possibleConstructorReturn(this, (Rezept.__proto__ || Object.getPrototypeOf(Rezept)).call(this, props));
        //this.randomTextDescription = this.randomTextDescription.bind(this);
    }

    _createClass(Rezept, [{
        key: 'randomTextDescription',
        value: function randomTextDescription() {
        ...
        key: 'renderNewList',
        value: function renderNewList(threeIngredients) {
            return threeIngredients.map(function (chosenElements) {
                return _react2.default.createElement(_eachOne.OneIngredient, { key: chosenElements,
                    src: chosenElements });
            });
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'img-flex-container' },
                    this.renderNewList(this.props.chosenInredientsImages)
                ),
                _react2.default.createElement(
                    'p',
                    { className: 'span-decor' },
                    _react2.default.createElement(
                        'span',
                        null,
                        'With these ingredients you can cook\xA0'
                    ),
                    _react2.default.createElement(
                        'span',
                        { className: 'menu' },
                        ' ',
                        this.randomTextDescription()
                    )
                ),
                _react2.default.createElement(
                    'span',
                ...
                _react2.default.createElement(
                    'a',
                    { className: 'span-decor click-button', onClick: this.props.turnToFirstPage },
                    'Choose new ingredients'
                )
            );
        }
    }]);
...
var _firstPage = __webpack_require__(44);

var _productPage = __webpack_require__(53);

var _basketPage = __webpack_require__(54);
...
var Parent = function (_React$Component) {
  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "centralization", style: styles },
        _react2.default.createElement(_firstPage.FirstPage, null),
        false && _react2.default.createElement(_productPage.ProductPage, null),
        false && _react2.default.createElement(_basketPage.BasketPage, null)
      );
    }
  }]);
...
var main = document.getElementsByClassName("shop")[0];

_reactDom2.default.render(_react2.default.createElement(Parent, null), main);
...
var _support = __webpack_require__(47);

var _collection = __webpack_require__(48);

var _brands = __webpack_require__(50);

var _customerReviews = __webpack_require__(51);

var _pageFooter = __webpack_require__(52);
  ...
  _createClass(FirstPage, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_support.Support, null),
        _react2.default.createElement(_collection.Collection, null),
        _react2.default.createElement(_brands.Brands, null),
        _react2.default.createElement(_customerReviews.Customers, null),
...
var Support = exports.Support = function (_React$Component) {
  ...
  _createClass(Support, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "section",
        { className: "first-page-support" },
        _react2.default.createElement(
          "div",
          { className: "first-page-support_container" },
          _react2.default.createElement(
            "div",
            { className: "first-page-support__services first-page-support__services_beige shipping" },
            _react2.default.createElement(
              "p",
              { className: "first-page-support__services_name" },
              "free sheeping"
            ),
            _react2.default.createElement(
              "p",
              { className: "first-page-support__services_undertext" },
              "In order min 200$"
            )
          ),
          _react2.default.createElement("div", { className: "first-page-support__services_triangle-beige-left" }),
          _react2.default.createElement(
            "div",
            { className: "first-page-support__services first-page-support__services_black " },
            _react2.default.createElement("div", { className: "first-page-support__services_triangle-white-left" }),
            _react2.default.createElement(
              "div",
              { className: "first-page-support__services_black_text-container return" },
              _react2.default.createElement(
                "p",
                { className: "first-page-support__services_name" },
                "30-days return"
            ...
            _react2.default.createElement("div", { className: "first-page-support__services_triangle-white-right" })
          ),
          _react2.default.createElement("div", { className: "first-page-support__services_triangle-beige-right" }),
          _react2.default.createElement(
            "div",
            { className: "first-page-support__services first-page-support__services_beige support" },
            _react2.default.createElement(
              "p",
              { className: "first-page-support__services_name" },
              "24/7 support"
...
var products = [{ image: "/images/online-shop/collection/collection_1.jpg", price: 300, discount: 0 }, { image: "/images/online-shop/collection/collection_2.jpg", price: 300, discount: 0 }, { image: "/images/online-shop/collection/collection_3.jpg", price: 300, discount: 0 }, { image: "/images/online-shop/collection/collection_4.jpg", price: 300, discount: 30 }, { image: "/images/online-shop/collection/collection_5.jpg", price: 300, discount: 0 }, { image: "/images/online-shop/collection/collection_6.jpg", price: 300, discount: 40 }, { image: "/images/online-shop/collection/collection_7.jpg", price: 300, discount: 0 }, { image: "/images/online-shop/collection/collection_8.jpg", price: 300, discount: 0 }];
  ...
  _createClass(Collection, [{
    ...
    value: function renderFunction() {
      return products.map(function (item) {
        return _react2.default.createElement(_item.Item, { image: item.image });
      });
    }
  }, {
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_headings.Headings, { headerName: "Summer Collection" }),
        _react2.default.createElement(
          "div",
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "first-page-collection__article_add" },
            "+add to cart"
          )
        )
      );
...
var Brands = exports.Brands = function (_React$Component) {
  ...
  _createClass(Brands, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "section",
        { className: "first-page-brands" },
        _react2.default.createElement(_headings.Headings, { headerName: "Brands" }),
        _react2.default.createElement(
          "div",
          { className: "first-page-brands_container" },
          _react2.default.createElement(
            "div",
            { className: "first-page-brands_padding" },
            _react2.default.createElement("div", { className: "first-page-brands__name bakery" }),
            _react2.default.createElement("div", { className: "first-page-brands__name harvest" }),
            _react2.default.createElement("div", { className: "first-page-brands__name lavalier" }),
            _react2.default.createElement("div", { className: "first-page-brands__name landlock" }),
            _react2.default.createElement("div", { className: "first-page-brands__name spectrum" }),
            _react2.default.createElement("div", { className: "first-page-brands__name home-energy" })
          )
        )
      );
    }
...
var Customers = exports.Customers = function (_React$Component) {
  ...
  _createClass(Customers, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "section",
        { className: "first-page-customer-reviews" },
        _react2.default.createElement(_headings.Headings, { headerName: "Customers says" }),
        _react2.default.createElement(
          "div",
          { className: "first-page-customer-reviews_container" },
          _react2.default.createElement("div", { className: "first-page-customer-reviews_triangle" }),
          _react2.default.createElement(
            "div",
            { className: "first-page-customer-reviews__customers" },
            _react2.default.createElement(
              "div",
              { className: "first-page-customer-reviews__customers_content-left" },
              _react2.default.createElement(
                "div",
                { className: "first-page-customer-reviews__customers_content-picture" },
                _react2.default.createElement("img", { src: "/images/online-shop/customers/sandra.png" })
              ),
              _react2.default.createElement(
                "div",
                { className: "first-page-customer-reviews__customers_content-left_description" },
                _react2.default.createElement(
                  "p",
                  { className: "opinion" },
            ...
            _react2.default.createElement(
              "div",
              { className: " first-page-customer-reviews__customers_content-right" },
              _react2.default.createElement(
                "div",
                { className: "first-page-customer-reviews__customers_content-picture" },
                _react2.default.createElement("img", { src: "/images/online-shop/customers/peter.png" })
              ),
              _react2.default.createElement(
                "div",
                { className: "first-page-customer-reviews__customers_content-right_description" },
                _react2.default.createElement(
                  "p",
                  { className: "opinion" },
                  "I have bought a T-Shirt,",
                  _react2.default.createElement("br", null),
...
var PageFooter = exports.PageFooter = function (_React$Component) {
  ...
  function PageFooter(props) {
    ...
    _this.renderTheList = _this.renderTheList.bind(_this);
    return _this;
  }

  _createClass(PageFooter, [{
    key: "renderTheList",
    value: function renderTheList(list) {
      var forReturn = list.items.map(function (itemName) {
        return _react2.default.createElement(
          "a",
          { className: "items", href: "/online-shop" },
          " ",
          itemName,
          " "
        );
      ...
      return _react2.default.createElement(
        "div",
        { className: "page-footer__upper_navigation_column" },
        _react2.default.createElement(
          "p",
          { className: "headings" },
          list.header
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("div", { className: "page-footer__lower_border-top" })
        )
      );
    }
  }]);
...
var BasketPage = exports.BasketPage = function (_React$Component) {
    _inherits(BasketPage, _React$Component);

    function BasketPage() {
        _classCallCheck(this, BasketPage);

        return _possibleConstructorReturn(this, (BasketPage.__proto__ || Object.getPrototypeOf(BasketPage)).apply(this, arguments));
    }
